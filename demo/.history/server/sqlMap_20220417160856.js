...
var sqlMap = {
  ...
  user: {
    ...
    select_user: 'select id, username, password, buildingNum from users',      //查询 id，用户名和密码
  ...
  admin: {
    ...
    update_info: 'update employee set username = ?, tel = ?, buildingNum = ? where id = ?',      //修改用户信息
  ...
  employee: {
    ...
    update_info: 'update employee set name = ?, tel = ?, position = ? where id = ?',      //修改员工信息
  },
  // 管理员看所有订单
  order: {
