  ...
  <div class="login">
    <div class="login_form">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="找回密码" name="fourth">
          <!-- 找回密码组件 -->
          <!-- <router-view></router-view> -->
          <Password></Password>
        </el-tab-pane>
        ...
        .then((res) => {
          ...
          for (var i = 0; res.data.length; i++) {
            ...
            if (
              ...
              this.$store.state.loginName = res.data[i].username
              this.$store.state.loginBuiNum = res.data[i].buildingNum
              this.$store.state.loginId = res.data[i].id
              // 登录，退出登录切换
