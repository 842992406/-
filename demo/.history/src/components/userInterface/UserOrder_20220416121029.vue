<template>
  <div>
    ...
    <el-table
      ...
      max-height="300"
    >
      <el-table-column prop="tableData.name" label="商品名称" width="160">
      </el-table-column>
      <el-table-column prop="tableData.price" label="单价" width="160">
      </el-table-column>
      <el-table-column prop="tableData.username" label="用户名" width="150">
      </el-table-column>
      <el-table-column fixed prop="tableData.id" label="编号" width="160">
      </el-table-column>
      <el-table-column prop="tableData.time" label="时间" width="160">
      </el-table-column>
      <!-- 删除操作 -->
...
export default {
  ...
  methods: {
    ...
    // 显示全体用户的数据
    getList() {
      this.$axios.get('/api/goods/getOrders', {}).then((res) => {
        var m = 0
