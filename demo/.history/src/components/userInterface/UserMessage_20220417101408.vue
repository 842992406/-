      ...
      <div id="main" style="margin-top: 5px; width: 800px; height: 400px">
        ...
        >
          <el-descriptions-item label="用户名"
            >{{ user.username }} <i class="el-icon-edit"></i
          ></el-descriptions-item>
          <el-descriptions-item label="手机号"
            >{{ user.tel }}<i class="el-icon-edit"></i
          ></el-descriptions-item>
          <el-descriptions-item label="所在地" :span="2"
            >{{ user.city }}<i class="el-icon-edit"></i
          ></el-descriptions-item>
          <el-descriptions-item label="备注">
            <el-tag size="small">学校学生 <i class="el-icon-edit"></i></el-tag>
          </el-descriptions-item>
          <el-descriptions-item label="所在楼号"
            >{{ user.buildingNum }}<i class="el-icon-edit"></i
          ></el-descriptions-item>
        </el-descriptions>
      </div>
    </el-card>
