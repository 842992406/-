  ...
  <div class="menu-box">
    ...
    >
      ...
      <el-menu-item
        ...
        @click="login"
        v-if="
          $store.state.getLoginFromLogin == false ||
          $store.state.getAdminLogin == false
        "
        >登录</el-menu-item
      >
      <!-- 退出登录按钮（登录成功之后显示） -->
      <el-menu-item
        ...
        @click="signOut"
        v-if="
          $store.state.getLoginFromLogin == true ||
          $store.state.getAdminLogin == true
        "
        >退出登录</el-menu-item
      >
      <!-- 用户个人中心按钮（登录成功之后显示） -->
      ...
      <el-menu-item
        index="2"
        class="elLeft4"
        v-if="$store.state.getAdminLogin == false"
        @click="drawer = true"
        >购物车</el-menu-item
      >
      <el-menu-item index="1" class="elLeft2" @click="Goods">首页</el-menu-item>
    </el-menu>
    <!-- 购物车位置 -->
...
export default {
  ...
  methods: {
    ...
    signOut() {
      this.$confirm('确定要退出吗?', '提示', {
        ...
        .then(() => {
          ...
          this.$store.state.getLoginFromLogin = false
          this.$store.state.getAdminLogin = false
    ...
    // 用户个人中心
    userMessage() {
      if (this.$store.state.getAdminLogin == true) {
