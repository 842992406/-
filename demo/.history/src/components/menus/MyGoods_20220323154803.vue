<template>
  <div>
      ...
      <div id="app">
        ...
        <div class="container">
          ...
          <div v-for="(item, index) in imgs" :key="index">
            ...
            <img :src="'http://localhost:8080/' + item.icon + '.png'" alt="" />
          </div>
        </div>
      </div>
      <!-- 商品名称 -->
    ...
    <el-table
      :data="tableData"
      style="width: 100%; position: relative; bottom: 19px; top: -80px"
      max-height="300"
    >
...
export default {
  ...
  methods: {
    ...
    add(e) {
      ...
      //利用axios发送post请求
      axios
        .post("http://localhost:8080/api/goods/addImage", param, {
    ...
    qy() {
      axios({
        url: "http://localhost:8080/api/goods/allImage",
        method: "get",
      }).then((res) => {
        //把后端返回数据赋值给imgs
