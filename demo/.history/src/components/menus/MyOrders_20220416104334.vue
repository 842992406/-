<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="price" label="单价" width="140"> </el-table-column>
      <el-table-column prop="username" label="订餐用户名" width="140">
      </el-table-column>
      <el-table-column prop="buildingNum" label="所在楼号" width="140">
      </el-table-column>
